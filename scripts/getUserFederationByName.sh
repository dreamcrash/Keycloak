...
curl -k -sS -X GET "https://$KEYCLOAK_IP/auth/admin/realms/$REALM_NAME/components?type=org.keycloak.storage.UserStorageProvider&parent=$REALM_NAME&name=$USER_FEDERATION_NAME" \
